...
Ejercicio 1 Estrutura de Estudiante
...
Ejercicio 4 Menú Operaciones 
Presenta un menú con 3 opciones y el usuario elije una de estas:
Verificar si un número es primo
Calcular el factorial de un número
Contar vocales en un texto (conteo individual por vocal)
